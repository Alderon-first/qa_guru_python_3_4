...
def print_inf_fnc(search_arg, arg_list, *args):
    ...
    for i in range(len(args)):
        # итерация по i где i от 0 до длинны arg
        # беру список args. цикл идет пока элементы не кончатмя
        # предполагаю, что список аргументов, взятый из
